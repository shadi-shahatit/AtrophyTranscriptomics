...
# Activate conda env with fastqc, trimmomatic, and salmon
...
# Define directories
work_dir="/TMBroilers_Transcriptomics/${tissue}"
adapters="/TMBroilers_Transcriptomics/adapters_truseq_v2.fa"
raw_dir="NewTranscriptiomeProject/${tissue}"
...
mkdir -p "${fastqc_dir}/raw" "${fastqc_dir}/trimmed"
...
quant_dir_r155="${work_dir}/quant_r115" # separate quant outputs
index_dir_r155="/TMBroilers_Transcriptomics/Ggallus_Refs/cdna_r115"
ref_trans_r155="/TMBroilers_Transcriptomics/Ggallus_Refs/cdna_r115/Gallus_gallus.bGalGal1.mat.broiler.GRCg7b.cdna.all.fa.gz"
